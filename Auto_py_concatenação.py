#Seguinte Gean, vc primeiro tem que importar essas bibliotecas. qualquer coisa pesquisa no google "Como importar uma biblioteca python" (pandas,nump,matplotlib)#
